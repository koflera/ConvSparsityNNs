...
To appear in the proceedings of the IEEE ISBI 2022 conference. Also, the accepted version of the paper can be found below:
...
>> N.B. For using this code, you have to use PyTorch version 1.7.0 as well as TorchKbNufft version 0.3.4 (https://github.com/mmuckley/torchkbnufft)
